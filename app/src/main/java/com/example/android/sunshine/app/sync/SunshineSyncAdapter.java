...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
     ...
     * @param autoInitialize whether to initialise automatically
     */
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            // Instead of always building the query based off the location string, we want to
            ...
            if (Utility.isLocationLatLongAvailable(context)) {
                ...
                uriBuilder.appendQueryParameter(LON_PARAM, locationLongitude);
            } else {
    ...
    /**
     * Display a notification that the weather data has changed.
     */
